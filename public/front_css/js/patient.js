jQuery(document).ready(function () {
    ...
    $(".next_btn").click(function () { // Function Runs On NEXT Button Click
        ...
        ga('send', {
            ...
            eventCategory: 'Patient Attendant - ' + term,
            eventAction: 'Next - ' + stepname,
            eventLabel: 'Patient Attendant'
        });
    ...
    $('#patientrates').click(function () {
        ...
        if (($('#patientrates').hasClass("collapsed")) == true) {
    ...
    function generateTable(isMetro) {
        ...
        url = '/patient/getPatientAttendantRates';
